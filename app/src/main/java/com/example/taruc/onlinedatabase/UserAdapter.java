package com.example.taruc.onlinedatabase;
...
import com.example.taruc.onlinedatabase.R;
...
public class UserAdapter extends ArrayAdapter<User> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        textViewAge = (TextView) rowView.findViewById(R.id.textViewAge);
        textViewMarried = (TextView) rowView.findViewById(R.id.textViewMarried);
